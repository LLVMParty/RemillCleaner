...
using ValueMap = std::unordered_map<const llvm::Value *, llvm::Value *>;
...
void CloneFunctionInto(const llvm::Function *source_func, llvm::Function *dest_func, llvm::ValueToValueMapTy &value_map);
...
// Note: this will try to clone globals referenced from the module of
//       `source_func` into the module of `dest_func`.
void CloneFunctionInto(const llvm::Function *source_func, llvm::Function *dest_func);
