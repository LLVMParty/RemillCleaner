...
; Function Attrs: alwaysinline mustprogress nofree norecurse nosync nounwind readonly uwtable willreturn
define dso_local float @__remill_read_memory_f32(%struct.Memory* nocapture readnone %m, i64 %a) local_unnamed_addr #0 {
entry:
  %arrayidx = getelementptr inbounds [0 x i8], [0 x i8]* @RAM, i64 0, i64 %a
...
; Function Attrs: alwaysinline mustprogress nofree norecurse nosync nounwind readonly uwtable willreturn
define dso_local double @__remill_read_memory_f64(%struct.Memory* nocapture readnone %m, i64 %a) local_unnamed_addr #0 {
entry:
  %arrayidx = getelementptr inbounds [0 x i8], [0 x i8]* @RAM, i64 0, i64 %a
...
; Function Attrs: alwaysinline mustprogress nofree norecurse nosync nounwind uwtable willreturn writeonly
define dso_local %struct.Memory* @__remill_write_memory_f32(%struct.Memory* readnone returned %m, i64 %a, float %v) local_unnamed_addr #2 {
entry:
  %arrayidx = getelementptr inbounds [0 x i8], [0 x i8]* @RAM, i64 0, i64 %a
...
; Function Attrs: alwaysinline mustprogress nofree norecurse nosync nounwind uwtable willreturn writeonly
define dso_local %struct.Memory* @__remill_write_memory_f64(%struct.Memory* readnone returned %m, i64 %a, double %v) local_unnamed_addr #2 {
entry:
  %arrayidx = getelementptr inbounds [0 x i8], [0 x i8]* @RAM, i64 0, i64 %a
